                    ...
                    child: new Container(
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Container(
                            child: new Text(GlobalConfig.h5,style: new TextStyle(color: GlobalConfig.fontColor,fontSize: 14.0),),
                          )
                        ],
                      ),
                    )),
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Container(
                            ...
                            child: new CircleAvatar(
                              radius: 20.0,
                              child: new Icon(Icons.text_format,color: Colors.white,),
                              backgroundColor: new Color(0xFF355A9B),
                            ),
                          ),
                          new Container(
                            child: new Text(GlobalConfig.App,style: new TextStyle(color: GlobalConfig.fontColor,fontSize: 14.0),),
                          )
                        ],
                      ),
                    )),
                      ...
                      child: new Column(
                        children: <Widget>[
                          new Container(
                            ...
                            child: new CircleAvatar(
                              radius: 20.0,
                              child: new Icon(Icons.local_movies,color: Colors.white,),
                    ...
                    child: new Container(
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Container(
                            child: new Text(GlobalConfig.welfare,style: new TextStyle(color: GlobalConfig.fontColor,fontSize: 14.0),),
                          )
                        ],
                      ),
                    )),
