            ...
            children: <Widget>[
              ...
              new Expanded(
                  child: new Container(
                    ...
                    child: new Text("妹子福利",style: new TextStyle(fontSize: 18.0),),
                  )),
              new Container(
                child: new FlatButton(
                    ...
                    child: Text("更多",style: new TextStyle(color: Colors.blue),)),
              )
            ],
          ),
        ),
                      ...
                      foregroundDecoration: new BoxDecoration(
                          image: new DecorationImage(
                              image: new NetworkImage(
                                  results!=null?
                                  PostData.fromJson(results[0]).url:"https://pic2.zhimg.com/50/v2-5942a51e6b834f10074f8d50be5bbd4d_400x224.jpg"),
                              centerSlice: new Rect.fromLTRB( 270.0, 180.0, 1360.0, 1730.0)
                          ),
